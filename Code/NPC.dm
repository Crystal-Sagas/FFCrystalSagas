			...
			DRank
				...
				Carbuncle
					...
					New()
						...
						var/obj/perk/monsterperk/Resistence_Black_Magic/b=new
						var/obj/perk/monsterperk/Tiny/c=new
						var/obj/perk/monsterperk/Mana_Connection/d=new
						var/obj/perk/monsterperk/Reaction_Emergency_Protection/e=new
						var/obj/perk/monsterperk/Bonus_Action_Extended_Casting/f=new
