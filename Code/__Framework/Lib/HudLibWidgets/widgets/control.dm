...
hud/widget/control
	...
	MouseDown(atom/location,control,params)
		...
		// CRITICAL FIX: Call parent to allow mouse event propagation
		..()
	...
	MouseDrag(over_object,src_location,over_location,src_control,over_control,params)
		// CRITICAL FIX: Call parent FIRST to ensure atom MouseDrag events work
		// This allows telekinesis and other atom-level mouse handlers to function
		..()
