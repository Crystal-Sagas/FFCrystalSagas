mob
	verb
		...
		ShowGeneralPerks()
			...
			for(var/obj/perkshopholder/ad in world)
				for(var/obj/perk/o in ad.contents)
		...
		ShowApproved()
			set hidden = 1
			var/row
			winset(usr,"TechWindow.techshop","cells=0x0")
			for(var/obj/techshopholder/ad in world)
				for(var/obj/perk/o in ad.contents)
					if(o.cat=="Martial")
						row++
						src<<output(o,"techshop:1,[row]")
