...
/obj/Ability/Magic/Arcane/Dark
	...
	scalingStat = "WIS"
	damageType = "magical"
	skillType = "Arcane Magic"
	actionType = "standard"
	element = "Dark"
	abilityRange = "6 tiles."
...
/obj/Ability/Magic/Arcane/Darkja
	...
	actionType = "standard"
	element = "Dark"
	abilityRange = "3x3 AoE at a point in view."
	attackRollDamageDice = TRUE
	attackRollDiceCount = 8
	attackRollDiceSides = 10
	baseCheck = 10
...
/obj/Ability/Magic/Arcane/Bioaga
	...
	actionType = "standard"
	element = "Bio"
	abilityRange = "10 tile range, 5x5 projectile."
	attackRollDamageDice = TRUE
	attackRollDiceCount = 5
	attackRollDiceSides = 12
	prerequisite = "Bioara"
...
/obj/Ability/Magic/Arcane/Scourge
	...
	actionType = "standard"
	element = "Bio"
	abilityRange = "3x3 AoE, spreading 1 tile in each direction each turn."
	attackRollDamageDice = TRUE
	attackRollDiceCount = 3
	attackRollDiceSides = 10
	prerequisite = "Bioaga"
...
/obj/Ability/Magic/Arcane/Toadga
	...
	actionType = "standard"
	element = "Bio"
	abilityRange = "10 tile range, 3x3 sized projectile."
	attackRollDamageDice = TRUE
	attackRollDiceCount = 5
	attackRollDiceSides = 12
	prerequisite = "Toad"
...
/obj/Ability/Magic/Arcane/Sleepga
	...
	actionType = "standard"
	element = "General"
	abilityRange = "5x5 AoE within 10 tiles."
	attackRollDamageDice = TRUE
	attackRollDiceCount = 3
	attackRollDiceSides = 10
	statusEffect = "Sleep"
...
/obj/Ability/Magic/Arcane/Corpse
	...
	saveType = "Reflex"
	element = "Death"
	abilityRange = "5x5 AoE within 8 tiles."
	attackRollDamageDice = TRUE
...
/obj/Ability/Magic/Arcane/BreakartPentagram
	...
	actionType = "standard"
	element = "Dark"
	abilityRange = "10 tile range, 5x5 AoE."
	attackRollDamageDice = TRUE
	attackRollDiceCount = 10
	attackRollDiceSides = 8
	baseCheck = 10
...
/obj/Ability/Magic/Arcane/Death
	...
	actionType = "standard"
	element = "Dark"
	abilityRange = "8 tile range."
	attackRollDamageDice = FALSE
	attackRollDamageExact = 4
	prerequisite = "Corpse"
	baseCheck = 10
