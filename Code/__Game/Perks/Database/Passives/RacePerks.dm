 ...
 * Race Perks
 *
 * This file contains race-specific perks that define the inherent
 * abilities and traits of each playable race in the game.
 * Each race has unique passive abilities that reflect their
 * cultural background, physiology, and connection to the world.
 */
