 ...
 * Role Perks
 *
 * Character role definitions that determine combat role.
 * These are the archetypes players choose during character creation.
 */
...
/obj/perk/Roleperks/PhysicalDPS
...
/obj/perk/Roleperks/PhysicalSupport
...
/obj/perk/Roleperks/MagicalSupport
