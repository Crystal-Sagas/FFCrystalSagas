...
mob
	verb
		...
		swapwepcat()
			...
			var/swapwep
			winset(usr,"Crafting.weaponrecipes","cells=0x0")
			var/list/wepchoices=list("Longsword","Focus Crystal","Scimitar","Shuriken","Throwing Knives","Axe","Hammer","Dagger","Claw","Gauntlet","Whip","Greatsword","Katana","Spear","Scythe","Bow","Focus Sword","Staff","Rod","Tome","Sword Spear","Thief Sword","Bolt Rapier","Whipblade","Akademia Cards","Blitz Ball","Gunblade","Bowsword","Bagangsaw","Buster Sword","Morphing Blade","Gun Arm","Magitek Pistol","Magitek Rifle")
