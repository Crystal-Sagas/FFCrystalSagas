		...
		Jobperks
			...
			MysticKnight
				...
				MysticKnight
					name="Mystic Knight"
					cat="Unique"
					desc="The Mystic Knight is the inverse of a Spellblade. Rather than infusing one's blade with specially crafted imbuement spells, they utilize the energy generated by using their weapons combined with mixing their own Mana, to cast spells in the midst of Melee combat. Mystic Knights have latent access to C Rank Black magic, and D Rank Arcane magic. A Mystic Knight gains 1 Kinetic Stack per round, as long as they have used at least 1 tile movement. +50 HP, +40 MP, +40 SP."
				BladeDancer
					name="Blade Dancer"
					rank="T1"
				...
				LivingBlade
					name="Living Blade"
					rank="T2"
					desc="The Mystic Knight tosses their weapon towards an ally in view or around themselves, enchanted with magical energy to move and defend. The weapon then acts as a protective tool, able to parry and deflect attacks for the ally in question. This can be used as a reaction to an attack towards the ally or caster, or as a pre-prepared standard action. While the Mystic Knight's weapon is acting as a ward for another creature, they can not use it as a weapon. When the protected creature would take damage, the Mystic Knight may use their reaction OR 1 Kinetic Stack in order to roll the damage for the weapon in question, and reduce the damage for that creature by the amount rolled, but drains 15 MP for doing so. Every usage after the first in the same round costs an additional 1 Kinetic stack on top of its previous cost. The Living Weapon may protect an ally until the end of the encounter, but in order to draw it back, the Mystic Knight must spend a Bonus Action. The Mystic Knight may change the ally the Living Weapon is protecting as a bonus action on their turn, if it is already protecting one."
				DefensiveBuildup
					name="Defensive Buildup"
					rank="T2"
					desc="Whenever the Mystic Knight manages to avoid an attack using their AC, they gain 1 'Kinetic Stack'. In addition, as long as the Mystic Knight has at least 1 Kinetic Stack, they gain 4 global damage reduction, as the magical energy passively protects them. A Mystic Knight gains AC equal to the amount of Kinetic Stacks they have (capping at +4.)"
				BladeDance
					name="Blade Dance"
					rank="T2"
					desc="The Mystic Knight may spend their bonus action to utilize the 'Blade Dance' ability. Doing so allows them to perform a series of magical slashes around their body, to create a hexagonal shield, protecting them from physical damage. Doing so costs 2 Kinetic stacks, and erects 'Protect' around them for 4 turns."
				BladeStorm
					name="Blade Storm"
					rank="T3"
					desc="The Mystic Knight has mastered their Blade Dance ability to the point that not only can they erect magical lines from a distance, but also for their entire party at once. When using the Blade Dance ability, they apply 'Protect' to all party members, not just themselves."
				ElementalProtection
					name="Elemental Protection"
					rank="T3"
					desc="The Mystic Knight is capable of applying elemental power to their Blade Dance. If they choose to do so, they may spend 10 MP (per protect) in order to imbue a target of their Blade Dance or Blade Storm ability with elemental protection of 1 type from the following list: Fire, Lightning, Thunder, Water, Ice, Earth, which grants resistance to that element for the duration of 'Protect'."
				MagicalReaction
					name="Magical Reaction"
					rank="T3"
					desc="This Mystic Knight has learned the intricacies of magical elements, and is able to add their chaotic reactiveness to the intricacy of their blade style. If a Mystic Knight damages a creature with a magical damage type, and that creature was hit with a Black Magic spell of a different elemental type within the last round, they may expend 1 'Kinetic Stack' to draw on the magical instabilities between the two elements to cause an explosion of magical energy, dealing 2d10+WIS force damage to the creature in question. This is a free action."
				ManaRod
					name="Mana Rod"
					rank="T4"
