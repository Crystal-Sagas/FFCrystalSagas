...
// /datum/controller/configuration/proc/load_config(override_file, reload_entries = TRUE)
...
/datum/controller/configuration/proc/load_admins(override_file, reload_entries = TRUE)
