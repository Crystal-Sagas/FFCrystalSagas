/datum/prototype/struct/loot_pack/incentive_box
	...
	some = list(
		...
		/obj/item/material/esper_soul = 1,
		/obj/item/material/flying_eyes_eye = 1,
		/obj/item/material/flying_eyes_wing = 1,
		/obj/item/material/tonberry_knife = 1,
		/obj/item/material/gigantoad_slime = 1,
		/obj/item/material/sahaugin_scale = 1,
